    ...
    return (
        <div className="w-50 p-5 rounded mx-auto">
            <div className="form-loading dropdown">
                <input style={{ backgroundColor: "rgba(145,158,171,0.04" }} id="search" value={search} onChange={(e) => setSearch(e.target.value)} type="text" className="form-control" placeholder="Search" autoComplete="off" />
